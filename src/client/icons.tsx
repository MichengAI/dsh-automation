...
export function PinOutlineIcon(props: IconProps): JSX.Element {
  return <FillIcon {...props}><path fill='currentColor' d='M9.2 1.2h1.6v4.1l2.7 2.2v1.6H8.5V7.5l2.7-2.2V1.2Zm-3.4 8.1h4.4v1.4H5.8V9.3ZM7.2 11.1h1.6V14.8H7.2V11.1Z' /></FillIcon>
}

export function UnpinOutlineIcon(props: IconProps): JSX.Element {
  return <FillIcon {...props}><path fill='currentColor' d='M9.2 1.2h1.6v4.1l2.7 2.2v1.6H8.5V7.5l2.7-2.2V1.2ZM2.1 2.8l.9-.9 10.9 10.9-.9.9L2.1 2.8Z' /></FillIcon>
}
