...
export function MenuSelect<T extends string>({
  ...
  return (
    <div className={`dsh-st-select${wide === true ? ' is-wide' : ''}`} ref={root}>
...
export function MenuPanel({
  ...
  return (
    <div className="dsh-st-select" ref={root}>
      <button type="button" className="dsh-st-chip-btn" onClick={() => setOpen(value => !value)}>{label}</button>
