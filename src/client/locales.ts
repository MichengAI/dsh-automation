...
export const en = {
  ...
  "sidebar.searchSessions": "Search session names",
  "sidebar.clearSearch": "Clear search",
  "sidebar.filter": "View options",
  "sidebar.groupBy": "Group by",
  "sidebar.groupWorkspace": "WorkSpace",
  "sidebar.groupWorkspaceTree": "Workspace Tree",
  "sidebar.groupList": "In one list",
  "sidebar.sortBy": "Order by",
  "sidebar.sortManual": "Manual",
  "sidebar.sortTime": "Last updated",
  "sidebar.filterBy": "Filter sessions",
  "sidebar.showArchived": "Show archived",
  "sidebar.onlyArchived": "Archived only",
  "header.lead":
    "Plan automatic tasks, or trigger them by hand. Describe the recurring work in any chat to create it quickly.",
  ...
  "examples.1.body":
    "Create a scheduled task that runs every day and inspects new test failures.",
  "examples.1.chip": "Every day 09:00",
  "examples.2.title": "Weekly dependency review",
  "examples.2.body":
    "Create a scheduled task that runs every Monday and reports outdated or risky dependencies.",
  "examples.2.chip": "Monday 10:00",
  "examples.3.title": "Weekday morning briefing",
  "examples.3.body":
    "Create a scheduled task that runs on weekdays and summarizes overnight changes.",
  "examples.3.chip": "Weekdays 08:00",
  "chat.hint":
    "In any conversation, describe the recurring work and ask the Agent to call automation_create.",
  "chat.prompt":
    "I want to create a scheduled task that runs every [interval] and does [the actual task]",
  "menu.run": "Run task",
  "menu.edit": "Edit task",
  ...
  "session.archiveGroupDescription":
    "Archive all {count} conversations for “{name}”. Choose Filter → Show archived to restore them.",
  "session.archiveGroupPending": "Archiving conversations…",
  "session.archiveGroupFailed":
    "Some conversations could not be archived: {message}",
  ...
  "session.deleteSessionDescription":
    "This permanently deletes session “{name}”, its child agents (including any that are still running), and all of its records (conversation, stats, cache). This cannot be undone.",
  ...
  "session.waitingApproval": "Waiting for approval",
  "session.planReview": "Plan to review",
  "session.waitingAnswer": "Waiting for an answer",
  "session.subagentsRunning": "{count} subagents running",
  ...
  "session.confirmDeleteFolderHint":
    'This only unlists {count} session(s) in "{name}" from Scheduled. Host sessions are not deleted and they stay hidden from Tasks.',
  ...
  "sort.default.save": "Set as default",
  ...
  "header.subtitle":
    "Schedule standalone, auditable Agent runs for this workspace.",
  ...
  "section.automationsHint":
    "Each trigger starts a fresh DSH Session and keeps its own audit record.",
  ...
  "empty.body":
    "Save a self-contained task, a schedule, and a permission boundary. Every run starts in a new Session.",
  "empty.action": "Create the first automation",
  "runs.empty":
    "No runs yet. Run one now, or wait for the next scheduled occurrence.",
  "overview.empty": "No scheduled tasks yet. Create one in Settings.",
  "form.title": "Create automation",
  "form.subtitle":
    "Write a complete, standalone task. Scheduled runs do not inherit this conversation.",
  "form.name": "Name",
  "form.namePlaceholder": "Daily regression triage",
  "form.prompt": "Task prompt",
  "form.promptPlaceholder":
    "Inspect new test failures, locate the regression, and propose a verified minimal fix…",
  ...
  "error.offline":
    "Could not reach the local automation service. Check that DSH is still running and try again.",
  ...
  "session.compactApproval": "Approval",
  "session.compactPlan": "Plan review",
  "session.compactAnswer": "Answer",
...
export const zh: Record<AutomationLocaleKey, string> = {
  ...
  "examples.1.body":
    "我要创建一个定时任务，每【天】执行【检查新增测试失败并给出最小修复】。",
  "examples.1.chip": "每天 09:00",
  "examples.2.title": "每周依赖巡检",
  "examples.2.body":
    "我要创建一个定时任务，每【周一】执行【检查过期或有风险的依赖并给出处理建议】。",
  "examples.2.chip": "每周一 10:00",
  "examples.3.title": "工作日早报",
  "examples.3.body":
    "我要创建一个定时任务，每【工作日】执行【汇总昨夜仓库变更并给出今日关注点】。",
  "examples.3.chip": "工作日 08:00",
  "chat.hint":
    "在任意对话中描述你想定期做的事，并让 Agent 调用 automation_create。",
  ...
  "session.archiveGroupDescription":
    "将归档“{name}”下的 {count} 个会话。可在筛选中选择“显示已归档”后恢复。",
  ...
  "session.deleteSessionDescription":
    "将永久删除会话“{name}”及其子代理（含正在运行的）和全部记录（对话内容、统计、缓存），此操作不可恢复。",
  ...
  "session.idle": "空闲",
  "session.runningStatus": "进行中",
  "session.completed": "已完成",
  "session.waitingApproval": "等待审批",
  "session.planReview": "计划待审",
  "session.waitingAnswer": "等待回答",
  "session.subagentsRunning": "{count} 个子代理运行中",
  "session.archived": "已归档",
  "session.delete": "从定时页移除",
  "session.deleteFolder": "从定时页移除文件夹",
  "session.confirmDeleteFolder": "从定时页移除这个文件夹？",
  "session.confirmDeleteFolderHint":
    "只会把「{name}」下的 {count} 条会话从定时页摘掉，不会删除宿主 Session。任务页本来也不展示这些自动化会话。",
  ...
  "section.automationsHint":
    "每次触发都会创建一个全新的 DSH Session，并保留独立审计记录。",
  "section.runs": "最近运行",
  "section.runsHint": "当前工作区最近的执行状态。",
  "section.refresh": "刷新",
  "empty.title": "让重复的编码工作自动运行",
  "empty.body":
    "设置一个目标明确的任务、运行时间和权限边界。每次运行都从全新 Session 开始。",
  ...
  "form.prompt": "任务指令",
  "form.promptPlaceholder":
    "检查新增测试失败，定位回归原因，并给出经过验证的最小修复方案……",
  "form.schedule": "运行计划",
  "form.planTime": "计划时间",
  "form.hourly": "每小时",
  "form.monthly": "每月",
  ...
  "session.copy": "复制",
  "session.copied": "已复制",
  "session.compactApproval": "待审批",
  "session.compactPlan": "计划待审",
  "session.compactAnswer": "待回答",
