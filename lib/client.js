...
function DropdownMenu({
  ...
  const [menuStyle, setMenuStyle] = (0, import_react3.useState)({});
  ...
  const menu = open && typeof document !== "undefined" ? (0, import_react_dom2.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { ref: menuRef, className: `dsh-st-dropdown-menu is-float${menuClassName === void 0 ? "" : ` ${menuClassName}`}`, style: menuStyle, children: options.map((option) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      DropdownRow,
      {
        label: option.label,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: `dsh-st-dropdown${className === void 0 ? "" : ` ${className}`}`, ref: root, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { type: "button", className: `dsh-st-dropdown-btn${open ? " is-open" : ""}`, "aria-label": ariaLabel, "aria-expanded": open, onClick: () => setOpen((value) => !value), children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh-st-dropdown-label", children: selectedLabel }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ChevronIcon, { width: 10, height: 10, className: "dsh-st-dropdown-chevron" })
    ] }),
    menu
  ] });
}
function DropdownRow({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh-st-dropdown-label-cell", children: label }),
        trailing !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh-st-dropdown-spacer" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh-st-dropdown-check", children: selected ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CheckOutlineIcon, { width: 16, height: 16 }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh-st-sort-tick" }) })
      ]
    }
  );
}
...
function SortMenu({
  ...
  const [saved, setSaved] = (0, import_react4.useState)(() => readSortDefault(storage, storageKey));
...
function AutomationView({ t, permissionT, modelT, runtime, closeSettings }) {
  ...
  const [tab, setTab] = (0, import_react5.useState)("mine");
  const [query, setQuery] = (0, import_react5.useState)("");
  const [creating, setCreating] = (0, import_react5.useState)(false);
  const [editingId, setEditingId] = (0, import_react5.useState)();
  const [draft, setDraft] = (0, import_react5.useState)();
  const [busy, setBusy] = (0, import_react5.useState)(false);
  const [error, setError] = (0, import_react5.useState)();
  const [historyRange, setHistoryRange] = (0, import_react5.useState)("day");
  const [historyTask, setHistoryTask] = (0, import_react5.useState)("all");
  const [historyStatus, setHistoryStatus] = (0, import_react5.useState)("all");
  const [sortKey, setSortKey] = (0, import_react5.useState)(() => readSortDefault(SORT_STORAGE, SETTINGS_SORT_DEFAULT_KEY)?.key ?? "created");
  const [sortDirection, setSortDirection] = (0, import_react5.useState)(() => readSortDefault(SORT_STORAGE, SETTINGS_SORT_DEFAULT_KEY)?.direction ?? "desc");
  const now = (0, import_react5.useMemo)(() => new Date(state.snapshot?.serverNow ?? Date.now()), [state.snapshot?.serverNow, state.refreshedAt]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh-st-shell", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("header", { className: "dsh-st-top", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh-st-heading", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h1", { children: t("tab") }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: t("header.lead") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh-st-toolbar", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("input", { className: "dsh-st-search", value: query, placeholder: t("search.placeholder"), onChange: (event) => setQuery(event.target.value) }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("button", { type: "button", className: "dsh-st-btn", onClick: () => {
          setChatPrefill(t("chat.prompt"));
          closeSettings?.();
        }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ChatIcon, {}),
          t("action.chatCreate")
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("button", { type: "button", className: "dsh-st-btn dsh-st-btn--primary", disabled: defaultPermission === "" || permissions.length === 0, onClick: () => openCreate(), children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(PlusIcon, {}),
          t("action.create")
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: "dsh-st-icon", onClick: () => {
          void runtime.refresh();
        }, "aria-label": t("section.refresh"), children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(RefreshIcon, {}) })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh-st-banner", role: "note", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(InfoIcon, {}),
      t("banner.wake")
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("section", { className: "dsh-st-examples", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh-st-examples-head", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h2", { children: t("examples.title") }) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh-st-example-row", children: EXAMPLES.map((example, index) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: t(`examples.${index + 1}.title`) }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: t(`examples.${index + 1}.body`) }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "dsh-st-chip", children: [
    ...
    error !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "dsh-st-error", children: error }),
    (state.phase === "idle" || state.phase === "loading" && snapshot === void 0) && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "dsh-st-muted", children: t("loading") }),
    state.phase === "error" && snapshot === void 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh-st-empty", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { children: t("error.title") }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: state.error }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: "dsh-st-btn dsh-st-btn--primary", onClick: () => {
        void runtime.refresh();
      }, children: t("error.retry") })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh-st-tabs", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: tab === "mine" ? "is-on" : "", onClick: () => setTab("mine"), children: t("tabs.mine") }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: tab === "runs" ? "is-on" : "", onClick: () => setTab("runs"), children: t("tabs.runs") }),
      tab === "mine" && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh-st-sort-wrap", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        SortMenu,
        {
          t,
      ...
      tab === "runs" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh-st-filters", children: [
        ["day", "week", "month"].map((range) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: historyRange === range ? "is-on" : "", onClick: () => setHistoryRange(range), children: t(`history.range.${range}`) }, range)),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          DropdownMenu,
          {
            ...
            options: [
              ...
              ...["succeeded", "failed", "running", "queued", "skipped", "cancelled"].map((status) => ({
                key: status,
    ...
    tab === "mine" && (automations.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh-st-empty", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { children: t("empty.title") }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: t("empty.body") })
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh-st-grid", children: automations.map((item) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      TaskCard,
      {
        item,
        t,
    ...
    tab === "runs" && (groups.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh-st-empty", children: t("runs.empty") }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh-st-timeline", children: groups.map((group) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("section", { className: "dsh-st-group", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { children: group.label }),
      group.items.map((run) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(RunRow, { run, t }, run.id))
    ] }, group.key)) })),
...
function TaskCard({
  ...
  const [menu, setMenu] = (0, import_react5.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("article", { className: "dsh-st-card", ref: root, onClick: onEdit, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh-st-card-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: `dsh-st-switch ${item.status === "active" ? "is-on" : ""}`, role: "switch", "aria-checked": item.status === "active", disabled: busy, onClick: (event) => {
        event.stopPropagation();
        onToggle();
      } }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: "dsh-st-more", onClick: (event) => {
        event.stopPropagation();
        setMenu((value) => !value);
      }, "aria-label": t("card.more"), children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(MoreIcon, {}) }),
      menu && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh-st-menu", onClick: (event) => event.stopPropagation(), children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("button", { type: "button", disabled: busy, onClick: () => {
          setMenu(false);
          onRun();
        }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(PlayIcon, { width: 16, height: 16 }),
          t("menu.run")
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("button", { type: "button", disabled: busy, onClick: () => {
          setMenu(false);
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(PencilIcon, { width: 16, height: 16 }),
          t("menu.edit")
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("button", { type: "button", className: "is-danger", disabled: busy, onClick: () => {
          setMenu(false);
          onDelete();
        }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TrashIcon, { width: 16, height: 16 }),
          t("menu.delete")
        ] })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { children: item.name }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: item.prompt }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh-st-card-foot", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "dsh-st-chip", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ClockIcon, {}),
        formatSchedule(item.schedule, t)
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: item.nextRunAt === void 0 ? t("stats.noneScheduled") : t("history.nextApprox", { when: formatWithin(item.nextRunAt, now, t) }) })
    ] })
  ] });
}
function RunRow({ run, t }) {
  const duration = formatDuration(run.startedAt, run.finishedAt);
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("article", { className: `dsh-st-run is-${run.status}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: run.automationName }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("p", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: clockTime(run.startedAt ?? run.scheduledFor) }),
      duration !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: duration }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: t("history.trigger") })
    ] })
  ] });
}
...
function deriveTaskOverviewRows(automations, runs) {
  const lastByAutomation = /* @__PURE__ */ new Map();
  for (const run of runs) {
    if (run.sessionId === void 0 || run.sessionId === "") continue;
    const current = lastByAutomation.get(run.automationId);
    const stamp = Date.parse(run.startedAt ?? run.scheduledFor);
    const currentStamp = current === void 0 ? Number.NaN : Date.parse(current.startedAt ?? current.scheduledFor);
    if (current === void 0 || stamp >= currentStamp) lastByAutomation.set(run.automationId, run);
  }
  return automations.map((item) => {
    ...
    return {
      ...
      ...last === void 0 ? {} : { lastSessionId: last.sessionId }
    };
  });
}
...
function ScheduleViewSwitch({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "dsh-st-rail-views", role: "tablist", "aria-label": t("sidebar.views"), children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", role: "tab", "aria-selected": view === "runs", className: view === "runs" ? "is-on" : void 0, onClick: () => onChange("runs"), children: t("tabs.runs") }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", role: "tab", "aria-selected": view === "overview", className: view === "overview" ? "is-on" : void 0, onClick: () => onChange("overview"), children: t("sidebar.viewOverview") })
  ] });
}
function ScheduleOverview({
  ...
  const [sortKey, setSortKey] = (0, import_react6.useState)(() => readSortDefault(SORT_STORAGE2, OVERVIEW_SORT_DEFAULT_KEY)?.key ?? "planned");
  const [sortDirection, setSortDirection] = (0, import_react6.useState)(() => readSortDefault(SORT_STORAGE2, OVERVIEW_SORT_DEFAULT_KEY)?.direction ?? "asc");
  const now = (0, import_react6.useMemo)(() => new Date(serverNow ?? Date.now()), [serverNow]);
  const rows = (0, import_react6.useMemo)(() => {
    ...
    return deriveTaskOverviewRows(sorted, runs).map((row) => {
      if (row.lastSessionId === void 0 || !keepScheduledSessionLink(row.lastSessionId, archived ?? EMPTY_SET, presentIds)) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "dsh-st-overview", children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "dsh-st-overview-toolbar", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      SortMenu,
      {
        t,
        compact: true,
    ...
    rows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "dsh-st-rail-empty", children: t("overview.empty") }) : rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(OverviewRow, { t, row, now, ...openSession === void 0 ? {} : { openSession } }, row.id))
  ] });
}
function OverviewRow({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
    "button",
    {
      ...
      disabled: row.lastSessionId === void 0,
      title: paused ? t("status.paused") : t("status.active"),
      onClick: () => {
        if (row.lastSessionId !== void 0) openSession?.(row.lastSessionId);
      },
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "dsh-st-rail-dot" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "dsh-st-overview-name", children: row.name }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "dsh-st-overview-time", children: row.nextRunAt === void 0 ? t("stats.noneScheduled") : formatWithin(row.nextRunAt, now, t) })
      ]
    }
  );
}
...
function WorkspaceToolbar({
  ...
  const [filterOpen, setFilterOpen] = (0, import_react7.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: searching ? "dsh-st-n-toolbar is-search" : "dsh-st-n-toolbar", ref: rootRef, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "dsh-st-n-head-acts", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dsh-st-n-head-filter", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { type: "button", className: filterOpen ? "dsh-st-n-head-btn is-on" : "dsh-st-n-head-btn", "aria-label": t("sidebar.filter"), "aria-expanded": filterOpen, onClick: () => setFilterOpen((open) => !open), children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(SlidersIcon, { width: 16, height: 16 }) }),
      filterOpen && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dsh-st-n-filter-menu", role: "menu", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "dsh-st-n-filter-label", children: t("sidebar.groupBy") }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(FilterRow, { label: t("sidebar.groupWorkspace"), selected: groupMode === "workspace", onSelect: () => {
          onGroupModeChange("workspace");
          setFilterOpen(false);
        } }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(FilterRow, { label: t("sidebar.groupList"), selected: groupMode === "list", onSelect: () => {
          onGroupModeChange("list");
          setFilterOpen(false);
        } }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "dsh-st-n-filter-split" }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "dsh-st-n-filter-label", children: t("sidebar.sortBy") }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(FilterRow, { label: t("sidebar.sortManual"), selected: sort === "manual", onSelect: () => {
          onSortChange("manual");
          setFilterOpen(false);
        } }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(FilterRow, { label: t("sidebar.sortTime"), selected: sort === "time", onSelect: () => {
          onSortChange("time");
          setFilterOpen(false);
        } })
      ] })
...
function FilterRow({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("button", { type: "button", role: "menuitemradio", "aria-checked": selected, className: selected ? "is-on" : void 0, onClick: onSelect, children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: label }),
    selected ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(CheckOutlineIcon, { width: 16, height: 16 }) : /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dsh-st-n-filter-tick" })
  ] });
}
...
function NativeScheduleSessionList(props) {
  ...
  const [sort, setSort] = (0, import_react8.useState)("time");
  const [groupMode, setGroupMode] = (0, import_react8.useState)("workspace");
  const [view, setView] = (0, import_react8.useState)("runs");
  ...
  const visibleGroups = (0, import_react8.useMemo)(() => applyWorkspaceBrowserQuery(groups.map((group) => ({ ...group, name: group.name })), query, sort, groupMode), [groups, query, sort, groupMode]);
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dsh-st-n", children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ScheduleViewSwitch, { t, view, onChange: setView }),
    view === "overview" ? state.snapshot === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "dsh-st-n-empty", children: state.phase === "loading" ? t("loading") : t("overview.empty") }) : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      ScheduleOverview,
      {
        t,
        ...
        archived,
        ...presentIds === void 0 ? {} : { presentIds }
      }
    ) : /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(WorkspaceToolbar, { t, query, sort, groupMode, onQueryChange: setQuery, onSortChange: setSort, onGroupModeChange: setGroupMode }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dsh-st-n-tree", role: "tree", children: [
        ...
        visibleGroups.map((group) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dsh-st-n-group", children: [
            groupMode === "workspace" && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dsh-st-n-row", role: "treeitem", "aria-expanded": expanded, onClick: () => setFolded((current) => ({ ...current, [group.id]: expanded })), children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "dsh-st-n-title", children: group.name })
            ] }),
            (groupMode === "list" || expanded) && group.sessions.map((session) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              NativeSessionRow,
              {
                t,
                id: session.id,
...
function NativeSessionRow(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: rowClass, ref: rowRef, role: "treeitem", tabIndex: 0, "aria-selected": selected, "data-n-menu-root": id, onClick: onOpen, onMouseEnter: showHover, onMouseLeave: hideHover, onKeyDown: (event) => {
    if (event.key === "Enter" || event.key === " ") {
      event.preventDefault();
      onOpen();
    }
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "dsh-st-n-slot", children: running ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(RunningStateDot, {}) : null }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "dsh-st-n-title", children: title }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "dsh-st-n-time", children: relativeTime(updatedAt) }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "dsh-st-n-acts", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: "dsh-st-n-ico", "aria-label": title + " \u66F4\u591A", onMouseDown: (event) => event.stopPropagation(), onClick: (event) => {
      event.stopPropagation();
      hideHover();
      onToggleMenu(event);
    ...
    hoverOpen && !menuOpen && typeof document !== "undefined" && (0, import_react_dom3.createPortal)(
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { ref: hoverRef, className: "dsh-st-n-hover", style: hoverStyle, onMouseEnter: showHover, onMouseLeave: hideHover, children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "dsh-st-n-hover-title", children: (hoverTitle ?? title).trim() || title }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "dsh-st-n-hover-time", children: relativeTime(updatedAt) }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dsh-st-n-hover-state", children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: running ? "dsh-st-n-hover-dot is-run" : "dsh-st-n-hover-dot" }),
...
function ScheduleRail({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dsh-st-rail", children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(ScheduleViewSwitch, { t, view, onChange: setView }),
    view === "overview" ? snapshot === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "dsh-st-rail-empty", children: state.phase === "loading" ? t("loading") : t("overview.empty") }) : /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      ScheduleOverview,
      {
        t,
...
.dsh-st-rail-views{display:flex;flex:none;gap:14px;padding:2px 8px 6px;border-bottom:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,.08))}
.dsh-st-rail-views button{appearance:none;border:0;background:transparent;color:var(--dsw-alias-label-secondary,#8b8f98);padding:6px 0;font-size:13px;cursor:pointer}
.dsh-st-rail-views button.is-on{color:var(--dsw-alias-label-primary,inherit);box-shadow:inset 0 -2px 0 currentColor}
.dsh-st-overview{display:flex;flex-direction:column;flex:1;min-height:0;overflow-y:auto;padding-right:var(--dsh-sidebar-inline-padding,12px)}
.dsh-st-overview-toolbar{display:flex;flex:none;justify-content:flex-end;align-items:center;gap:6px;padding:4px 0 8px}
.dsh-st-overview-row{display:flex;align-items:center;gap:8px;width:100%;min-height:28px;padding:3px 8px;border:0;border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary,#9ca39f);text-align:left;cursor:pointer}
.dsh-st-overview-row:hover{background:var(--dsw-alias-interactive-bg-hover,rgba(255,255,255,.06))}
.dsh-st-overview-row:disabled{opacity:.55;cursor:default}
.dsh-st-overview-row:disabled:hover{background:transparent}
.dsh-st-overview-row .dsh-st-rail-dot{flex:none;margin-left:2px}
.dsh-st-overview-row.is-paused .dsh-st-rail-dot{background:#8b8f98}
.dsh-st-overview-name{min-width:0;flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px}
.dsh-st-overview-time{flex:none;color:var(--dsw-alias-label-tertiary,#8b8f98);font-size:12px}
