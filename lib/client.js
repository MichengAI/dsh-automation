...
function RunRow({ run, t }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("article", { className: `dsh-st-run is-${run.status}`, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("p", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { children: t(run.trigger === "manual" ? "history.triggerManual" : run.trigger === "catch-up" ? "history.triggerCatchUp" : "history.trigger") })
    ] })
  ] });
}
...
var en = {
  ...
  "history.triggerManual": "Manual",
  "history.triggerCatchUp": "Catch-up",
...
var zh = {
  ...
  "history.triggerManual": "\u624B\u52A8\u89E6\u53D1",
  "history.triggerCatchUp": "\u8865\u507F\u89E6\u53D1",
