...
function RunRow({ run, t }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("article", { className: `dsh-st-run is-${run.status}`, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("p", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { children: t("history.trigger") })
    ] })
  ] });
}
...
function ScheduleOverview({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dsh-st-overview", children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "dsh-st-overview-toolbar", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      SortMenu,
      {
        t,
        compact: true,
    ...
    rows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "dsh-st-rail-empty", children: t("overview.empty") }) : rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(OverviewRow, { t, row, now, ...openSession === void 0 ? {} : { openSession } }, row.id))
  ] });
}
function OverviewRow({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dsh-st-rail-dot" }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dsh-st-overview-name", children: row.name }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dsh-st-overview-time", children: row.nextRunAt === void 0 ? t("stats.noneScheduled") : formatWithin(row.nextRunAt, now, t) })
      ]
    }
  );
}
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dsh-st-n-tree", role: "tree", children: [
        ...
        visibleGroups.map((group) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dsh-st-n-group", children: [
            groupMode === "workspace" && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dsh-st-n-row", role: "treeitem", "aria-expanded": expanded, onClick: () => setFolded((current) => ({ ...current, [group.id]: expanded })), children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "dsh-st-n-title", children: group.name })
            ] }),
...
function NativeSessionRow(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: rowClass, ref: rowRef, role: "treeitem", tabIndex: 0, "aria-selected": selected, "data-n-menu-root": id, onClick: onOpen, onMouseEnter: showHover, onMouseLeave: hideHover, onKeyDown: (event) => {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "dsh-st-n-acts", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: "dsh-st-n-ico", "aria-label": title + " \u66F4\u591A", onMouseDown: (event) => event.stopPropagation(), onClick: (event) => {
      event.stopPropagation();
      hideHover();
      onToggleMenu(event);
...
function ScheduleRail({
  ...
  const [view, setView] = (0, import_react10.useState)("runs");
  const snapshot = state.snapshot;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "dsh-st-rail", children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ScheduleViewSwitch, { t, view, onChange: setView }),
...
function NativeScheduleShell({
  ...
  const scheduleBody = hostedSchedule === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(NativeScheduleSessionList, { t, runtime, ...openSession === void 0 ? {} : { openSession }, ...useSessions === void 0 ? {} : { useSessions }, ...useWorkspaces === void 0 ? {} : { useWorkspaces } }) : hostedSchedule.render({ ...hostProps ?? {}, openSession, open: openSession, useSessions, wide: true });
