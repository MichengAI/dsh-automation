...
function asUiWorkspace(value) {
  if (value === null || typeof value !== "object") return void 0;
  const openSession = value.openSession;
  if (typeof openSession !== "function") return void 0;
  return { openSession: (id) => {
    openSession.call(value, id);
  } };
}
function probeService(ctx, name2) {
  const reflectGet = ctx.reflect?.get;
  if (typeof reflectGet === "function") {
    try {
      return reflectGet.call(ctx.reflect, name2);
    } catch {
    }
  }
...
function resolveClientSessionOpenAccess(ctx) {
  const uiWorkspace = asUiWorkspace(probeService(ctx, "uiWorkspace"));
  return {
    ...uiWorkspace === void 0 ? {} : { uiWorkspace },
    ...ctx.sessions === void 0 ? {} : { sessions: ctx.sessions }
  };
}
function canOpenClientSession(access) {
  return typeof access.uiWorkspace?.openSession === "function" || typeof access.sessions?.open === "function";
}
function openClientSession(access, id) {
...
var en = {
  ...
  "session.deleteSessionConfirm": "Delete session",
  "session.deleteSessionDescription": "This permanently deletes session \u201C{name}\u201D, its child agents (including any that are still running), and all of its records (conversation, stats, cache). This cannot be undone.",
  "session.deleteSessionPending": "Deleting session\u2026",
  "session.deleteSessionFailed": "Could not delete the session: {message}",
  "session.deleteSessionClose": "Close",
  "session.deleteSessionCancel": "Cancel",
  "session.idle": "Idle",
...
var zh = {
  ...
  "session.deleteSessionConfirm": "\u5220\u9664\u4F1A\u8BDD",
  "session.deleteSessionDescription": "\u5C06\u6C38\u4E45\u5220\u9664\u4F1A\u8BDD\u201C{name}\u201D\u53CA\u5176\u5B50\u4EE3\u7406\uFF08\u542B\u6B63\u5728\u8FD0\u884C\u7684\uFF09\u548C\u5168\u90E8\u8BB0\u5F55\uFF08\u5BF9\u8BDD\u5185\u5BB9\u3001\u7EDF\u8BA1\u3001\u7F13\u5B58\uFF09\uFF0C\u6B64\u64CD\u4F5C\u4E0D\u53EF\u6062\u590D\u3002",
  "session.deleteSessionPending": "\u6B63\u5728\u5220\u9664\u4F1A\u8BDD\u2026",
  "session.deleteSessionFailed": "\u5220\u9664\u4F1A\u8BDD\u5931\u8D25\uFF1A{message}",
  "session.deleteSessionClose": "\u5173\u95ED",
  "session.deleteSessionCancel": "\u53D6\u6D88",
  "session.idle": "\u7A7A\u95F2",
...
function canDeleteScheduledSession(archiveManagerInstalled, deleteSession) {
  return archiveManagerInstalled && deleteSession !== void 0;
}
function scheduledSessionMenuActions(canDelete) {
  return canDelete ? ["rename", "fork", "archive", "delete-session"] : ["rename", "fork", "archive"];
}
function scheduledGroupShowsActiveFolder(sessionIds, selectedId) {
  return selectedId !== null && sessionIds.includes(selectedId);
}
function scheduledSessionOmitsStatusSlot(flat, running) {
  return flat && !running;
}
...
function NativeScheduleSessionList(props) {
  const { t, runtime, openSession, useSessions, useWorkspaces, renameSession, archiveSession, deleteSession, forkSession, openTaskSettings } = props;
  ...
  const [openMenu, setOpenMenu] = (0, import_react9.useState)();
  ...
  const [deleteSessionTarget, setDeleteSessionTarget] = (0, import_react9.useState)();
  const [deleteSessionBusy, setDeleteSessionBusy] = (0, import_react9.useState)(false);
  const [deleteSessionError, setDeleteSessionError] = (0, import_react9.useState)();
  ...
  const confirmDeleteSession = () => {
    if (deleteSessionTarget === void 0 || deleteSession === void 0 || deleteSessionBusy) return;
    const target = deleteSessionTarget;
    setDeleteSessionBusy(true);
    setDeleteSessionError(void 0);
    void Promise.resolve(deleteSession(target.id)).then(() => {
      setDeleteSessionTarget(void 0);
    }).catch((caught) => {
      setDeleteSessionError(caught instanceof Error ? caught.message : t("error.action"));
    }).finally(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dsh-st-n", children: [
    ...
    view === "overview" ? state.snapshot === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "dsh-st-n-empty", children: state.phase === "loading" ? t("loading") : t("overview.empty") }) : /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "dsh-st-n-list-area", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dsh-st-n-tree", role: "tree", children: [
            ...
            (groupMode === "list" || expanded) && group.sessions.map((session) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
              NativeSessionRow,
              {
                ...
                onMenuChange: (open) => {
                  ...
                  setOpenMenu(open ? session.id : void 0);
                },
                onOpen: () => {
                  setOpenMenu(void 0);
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
      import_dsh_client_ui_primitives3.Modal,
      {
        open: deleteSessionTarget !== void 0,
        onClose: () => {
        ...
        footer: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dsh-st-n-dialog-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_dsh_client_ui_primitives3.Button, { variant: "outline", disabled: deleteSessionBusy, onClick: () => {
            setDeleteSessionTarget(void 0);
            setDeleteSessionError(void 0);
          }, children: t("session.deleteSessionCancel") }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_dsh_client_ui_primitives3.Button, { variant: "outline", className: "dsh-st-n-danger-button", disabled: deleteSessionBusy, onClick: confirmDeleteSession, children: t("session.deleteSessionConfirm") })
        ] }),
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: "dsh-st-n-dialog-copy", children: deleteSessionTarget === void 0 ? "" : t("session.deleteSessionDescription", { name: deleteSessionTarget.title }) }),
          deleteSessionBusy && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "dsh-st-n-dialog-status", role: "status", children: t("session.deleteSessionPending") }),
          deleteSessionError !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "dsh-st-n-dialog-error", role: "alert", children: t("session.deleteSessionFailed", { message: deleteSessionError }) })
        ]
      }
    )
  ] });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "dsh-st-n-slot dsh-st-n-chevron", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(ChevronIcon, { width: 14, height: 14, className: "dsh-st-n-arrow" + (expanded ? " is-open" : "") }) }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "dsh-st-n-project-text", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "dsh-st-n-title", children: name2 }) }),
...
function NativeSessionRow(props) {
  const { t, flat, id, title, hoverTitle, updatedAt, running, selected, menuOpen, canDelete, onMenuChange, onOpen, onDeleteSession, renameSession, archiveSession, forkSession } = props;
  ...
  const rowClass = "dsh-st-n-sess" + (selected ? " is-on" : "") + (menuOpen ? " is-menu" : "") + (omitStatusSlot ? " is-flat-idle" : "");
  if (renaming) {
  ...
  const items = scheduledSessionMenuActions(canDelete).map((action) => {
    if (action === "rename") return { id: action, label: t("session.rename"), icon: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_dsh_client_ui_primitives3.IconEditOutline16, {}) };
    if (action === "fork") return { id: action, label: t("session.fork"), icon: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_dsh_client_ui_primitives3.IconBranchOutline16, {}) };
    if (action === "archive") return { id: action, label: t("session.archive"), icon: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_dsh_client_ui_primitives3.IconArchiveOutline20, { size: 16 }) };
    return { id: action, label: t("session.deleteSession"), icon: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_dsh_client_ui_primitives3.IconTrashOutline16, {}), danger: true };
  });
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: rowClass, ref: rowRef, role: "treeitem", tabIndex: 0, "aria-selected": selected, "data-n-menu-root": id, onClick: onOpen, onMouseEnter: showHover, onMouseLeave: hideHover, onKeyDown: (event) => {
    ...
    !omitStatusSlot && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "dsh-st-n-slot", children: running ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(RunningStateDot, {}) : null }),
...
var SETTINGS_CODEX_TRIGGER_SELECTOR = "[data-dcu-settings-trigger]";
var SETTINGS_CODEX_PAGE_SELECTOR = "[data-dcu-settings-page]";
var SETTINGS_OPEN_SECTION_EVENT = "dcu-settings-open-section";
function requestCodexSettingsSection(labels) {
  const trigger = document.querySelector(SETTINGS_CODEX_TRIGGER_SELECTOR);
...
function openSettingsSection(labels, onSelected, onMissing) {
  ...
  if (!dialogOpen && !pageOpen && launcher === void 0 && pageTrigger === null) {
    onMissing?.();
    return;
  }
...
function apply(ctx) {
  ...
  const openTaskSettings = (request) => {
  ...
  ctx.slots.inject("settings.section", () => ctx.slots.register({
    ...
    return (0, import_react11.createElement)(AutomationView, { t, permissionT, modelT, runtime, ...props.close === void 0 ? {} : { closeSettings: props.close } });
  }));
  ctx.slots.inject("sidebar.schedule", () => ctx.slots.register({
    ...
    return (0, import_react11.createElement)(ScheduleRail, {
      t,
      runtime,
      openSession: createScheduledSessionOpener(ctx, runtime, props.openSession),
      openTaskSettings,
      ...props.view === void 0 ? {} : { view: props.view },
      ...props.showViewSwitch === void 0 ? {} : { showViewSwitch: props.showViewSwitch }
    });
  }));
  ctx.slots.inject("sidebar.workspaces", () => {
    ...
    let ownedWrapper;
    let ownedRegistry;
    let insertedRegistry;
    let removeInsertedTab = () => void 0;
    let syncing = false;
    let retryTimer;
    const notifyPeers = () => {
      queueMicrotask(() => window.dispatchEvent(new Event("dsh-native-sidebar-change")));
    };
    ...
    const unwrap = () => {
      ...
      insertedRegistry = void 0;
      if (wrappedEntry !== void 0) {
        if (originalComp !== void 0 && wrappedEntry.component === ownedWrapper) wrappedEntry.component = originalComp;
        const record = wrappedEntry;
    ...
    const insertScheduleTab = (entry, openSession) => {
      ...
      removeInsertedTab = registry.insert({
        ...
        render: (props) => {
          ...
          return (0, import_react11.createElement)(NativeScheduleSessionList, {
            t,
            runtime,
            openSession: opener,
    ...
    const sync = () => {
      ...
      try {
        let AutomationNativeWorkspaceShell2 = function(innerProps) {
          ...
          return (0, import_react11.createElement)(NativeScheduleShell, {
            t,
            runtime,
        ...
        const entries = readSlotEntries(ctx, "sidebar.workspaces");
        const active = entries.find((entry) => entry?.component !== void 0);
        if (wrappedEntry !== void 0 && (active !== wrappedEntry || active.component !== ownedWrapper)) unwrap();
        if (active === wrappedEntry && active?.component === ownedWrapper && ownedWrapper !== void 0) {
          ensureScheduleTab();
          return;
        }
        if (active === void 0) {
    ...
    const unsubSidebar = ctx.slots.subscribe?.("sidebar", sync) ?? (() => void 0);
    window.addEventListener("dsh-native-sidebar-change", sync);
    ensureScheduleTab();
    return () => {
      unsub();
      unsubSidebar();
      window.removeEventListener("dsh-native-sidebar-change", sync);
      unwrap();
    };
  });
  ...
  return (sessionId) => {
    ...
    void ensureOpenScheduledSession({
      ...
      listed: (id) => {
        ...
        return (snap?.ids ?? []).includes(id) || snap?.byId?.[id] !== void 0;
      },
      ...ctx.sessions?.refresh === void 0 ? {} : { refresh: () => ctx.sessions.refresh() },
      ...canOpenClientSession(access) ? { openRuntime: (id) => {
        openClientSession(access, id);
      } } : {},
