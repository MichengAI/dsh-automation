...
function createAutomationRuntime(rpc) {
  ...
  return {
    ...
    async runNow(automationId) {
      ...
      const result = unwrapRpcResult(await callRpc("run-now", payload));
      await refresh();
...
var en = {
  ...
  "menu.run": "Run task",
  "menu.edit": "Edit task",
  "menu.pause": "Pause task",
  "menu.resume": "Resume task",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dsh-st-n", children: [
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dsh-st-n-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              NativeScheduleGroupRow,
              {
                ...
                canArchiveGroup,
                onRunTask: () => {
                  void runtime.runNow(group.id);
                },
                onToggleTask: () => {
                  void runtime.mutateAutomation(group.id, group.automation?.status === "active" ? "pause" : "resume");
                },
                onDeleteTask: () => {
                  if (group.automation !== void 0) setDeleteTaskTarget(group.automation);
                },
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      DeleteConfirmation,
      {
        ...
        t,
        busy: deleteTaskBusy,
        onCancel: () => setDeleteTaskTarget(void 0),
        onConfirm: () => {
          const target = deleteTaskTarget;
          if (target === void 0) return;
          setDeleteTaskBusy(true);
          void runtime.mutateAutomation(target.id, "delete").then(() => setDeleteTaskTarget(void 0)).finally(() => setDeleteTaskBusy(false));
        }
      }
    ),
...
function NativeScheduleGroupRow(props) {
  ...
  const items = [
    ...
    { id: "toggle-task", label: automation?.status === "active" ? t("menu.pause") : t("menu.resume"), icon: automation?.status === "active" ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(PauseIcon, { width: 16, height: 16 }) : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(PlayIcon, { width: 16, height: 16 }) },
