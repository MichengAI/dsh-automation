...
var UPDATE_ICON_COMPONENTS = {
  refresh: import_dsh_client_ui_primitives4.IconRefreshOutline16,
  download: import_dsh_client_ui_primitives4.IconDownloadOutline16,
  copy: import_dsh_client_ui_primitives4.IconCopyOutline16,
  close: import_dsh_client_ui_primitives4.IconCloseOutline16
};
function createPluginUpdateIcon(name2) {
  const element = document.createElement("span");
  (0, import_client.createRoot)(element).render((0, import_react11.createElement)(UPDATE_ICON_COMPONENTS[name2], { size: 16 }));
  return element;
}
