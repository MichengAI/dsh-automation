...
function sortAutomations(items, key, direction) {
  ...
  return items.slice().sort((left, right) => {
    ...
    const primary = key === "title" ? left.name.localeCompare(right.name) : sortStamp(left.createdAt) - sortStamp(right.createdAt);
...
function AutomationView({ t, permissionT, modelT, runtime, closeSettings }) {
  ...
  const [sortKey, setSortKey] = (0, import_react3.useState)("planned");
...
function SortMenu({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-st-sort", ref: root, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { type: "button", className: `dsh-st-sort-btn${open ? " is-open" : ""}`, "aria-label": t("sort.by"), "aria-expanded": open, onClick: () => setOpen((value) => !value), children: [
      t("sort.by"),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ChevronIcon, { className: "dsh-st-sort-chevron" })
    ] }),
    open && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-st-sort-menu", role: "menu", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh-st-sort-label", children: t("sort.field") }),
      fields.map((field) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        SortRow,
        {
          ...
          onSelect: () => {
            setOpen(false);
            onSelect(field.key, sortDirection);
          }
        },
        field.key
      )),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh-st-sort-split" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh-st-sort-label", children: t("sort.direction") }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SortRow, { label: t("sort.direction.asc"), selected: sortDirection === "asc", onSelect: () => {
        setOpen(false);
        onSelect(sortKey, "asc");
      } }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SortRow, { label: t("sort.direction.desc"), selected: sortDirection === "desc", onSelect: () => {
        setOpen(false);
        onSelect(sortKey, "desc");
      } })
    ] })
  ] });
}
function SortRow({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { type: "button", role: "menuitemradio", "aria-checked": selected, className: selected ? "is-on" : void 0, onClick: onSelect, children: [
...
var en = {
  ...
  "sort.key.created": "Created time",
  "sort.key.planned": "Planned time",
...
var zh = {
  ...
  "sort.field": "\u6392\u5E8F\u5B57\u6BB5",
  "sort.direction": "\u6392\u5E8F\u65B9\u5411",
  "sort.key.created": "\u521B\u5EFA\u65F6\u95F4",
  "sort.key.planned": "\u8BA1\u5212\u65F6\u95F4",
  "sort.key.title": "\u6807\u9898",
...
.dsh-st-sort-label{padding:6px 10px 4px;font-size:12px;line-height:18px;color:var(--dsw-alias-label-tertiary,#81858C)}
.dsh-st-sort-split{height:1px;margin:6px 8px;background:var(--dsw-alias-border-l2,rgba(255,255,255,.1))}
