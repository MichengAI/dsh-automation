...
function MenuSelect({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: `dsh-st-select${wide === true ? " is-wide" : ""}`, ref: root, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "button", className: "dsh-st-select-btn", onClick: () => setOpen((value2) => !value2), children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: current }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("em", {})
    ] }),
    open && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh-st-select-menu", children: options.map((item) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      "button",
      {
        type: "button",
...
function MenuPanel({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh-st-select", ref: root, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh-st-chip-btn", onClick: () => setOpen((value) => !value), children: label }),
    open && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh-st-select-menu", children })
  ] });
}
...
function CreateModal({
  ...
  const workspace = workspaces.find((item) => item.id === form.workspaceId);
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh-st-mask", role: "presentation", onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("form", { className: "dsh-st-modal", onClick: (event) => event.stopPropagation(), onSubmit: handleSubmit, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-st-modal-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h2", { children: t("modal.title") }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "dsh-st-field", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-st-prompt-card", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-st-composer", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(MenuPanel, { label: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
            "\u{1F4C1} ",
            workspace?.title || t("form.workspace")
          ] }), children: workspaces.map((item) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { type: "button", className: item.id === form.workspaceId ? "is-on" : "", onClick: () => update({ workspaceId: item.id }), children: [
            item.title,
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("small", { children: item.path })
          ] }, item.id)) }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh-st-composer-right", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(MenuPanel, { label: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
              "\u2726 ",
              t("form.skills"),
              form.skills.length > 0 ? ` ${form.skills.length}` : ""
            ] }), children: [
...
function TaskCard({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("article", { className: "dsh-st-card", ref: root, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-st-card-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: `dsh-st-switch ${item.status === "active" ? "is-on" : ""}`, role: "switch", "aria-checked": item.status === "active", disabled: busy, onClick: onToggle }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: "dsh-st-more", onClick: () => setMenu((value) => !value), "aria-label": t("card.delete"), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(MoreIcon, {}) }),
      menu && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-st-menu", children: [
