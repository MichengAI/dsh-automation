...
export declare const en: {
    ...
    readonly "sidebar.sessions": "Sessions";
    readonly "sidebar.searchSessions": "Search session names";
    readonly "sidebar.clearSearch": "Clear search";
    readonly "sidebar.filter": "View options";
    readonly "sidebar.groupBy": "Group by";
    readonly "sidebar.groupWorkspace": "WorkSpace";
    readonly "sidebar.groupWorkspaceTree": "Workspace Tree";
    readonly "sidebar.groupList": "In one list";
    readonly "sidebar.sortBy": "Order by";
    readonly "sidebar.sortManual": "Manual";
    readonly "sidebar.sortTime": "Last updated";
    readonly "sidebar.filterBy": "Filter sessions";
    readonly "sidebar.showArchived": "Show archived";
    readonly "sidebar.onlyArchived": "Archived only";
    ...
    readonly "session.archiveGroupDescription": "Archive all {count} conversations for “{name}”. Choose Filter → Show archived to restore them.";
    ...
    readonly "session.completed": "Completed";
    readonly "session.waitingApproval": "Waiting for approval";
    readonly "session.planReview": "Plan to review";
    readonly "session.waitingAnswer": "Waiting for an answer";
    readonly "session.subagentsRunning": "{count} subagents running";
    readonly "session.archived": "Archived";
    ...
    readonly "session.copied": "Copied";
    readonly "session.compactApproval": "Approval";
    readonly "session.compactPlan": "Plan review";
    readonly "session.compactAnswer": "Answer";
